...
https://gitlab.studip.de/studip/studip/-/issues?milestone_title=Stud.IP+6.1&state=all
- Seminare-Semester-Tabelle speichert nicht mkdate und chdate [#31033]
- Belegungsplan: "Alle Anfragen anzeigen" standardmäßig immer anzeigen [#34527]
- Courseware Blöcke und Abschnitte standortspezifisch anbieten [#34637]
- Klasse ContentGroupMenu sollte von ActionMenu abgeleitet sein [#35536]
- Neue Funktionen für: "Vorläufige Teilnehmende eintragen" [#36330]
- ILIAS-Arbeitsbereiche über Stud.IP verwalten und anzeigen [#36621]
- Erweiterung und Optimierung der von der ILIAS-Schnittstelle angelegten Strukturkategorien [#36622]
- Veranstaltungsüberischt: Icons pro Teilbereich laden [#37195]
- Wiki: Alle Seiten: Bulk-Action zum Ändern der Berechtigungen hinzufügen [#37203]
- Neue Optionen für die Ilias Schnittstelle [#37263]
- Stundenplan-Widget für den persönlichen Kalender erweitern [#37606]
- Raumverwaltung: Rüstzeiten nach einer Raumbuchung erlauben [#37861]
- Forum 3 [#37886]
- Log-Einträge für Cronjobs [#38104]
- Verbesserungen an der Pipeline [#38264]
- PHP: Bibliothek scssphp/scssphp auf Version 2.0.1 aktualisieren [#38301]
- Color-Themes-System [#38308]
- Erweiterung der Modulverwaltung um Studiengangsspezifische Informationen [#38343]
- PDF-Dateien annotieren [#38384]
- URL in background-image setzt redundante Anführungszeichen [#38398]
- Ausbau der "Chance" für Meine Veranstaltungen [#38535]
- MySQL auch in der Pipeline verwenden [#38590]
- webpack: Cross Chunks Packages [#38601]
- Neue Icons für Video-Calls [#38644]
- Updates der PHP-Bibliotheken (Stud.IP 6.1) [#38655]
- Polyfills für PHP 8.5 einbinden [#38656]
- Update monolog/monolog auf v2.9.3 auf v3.9.0 [#38658]
- Update illuminate/collections v10.48.12 auf v10.48.28 [#38659]
- Ersetzen von maximebf/debugbar v1.22.3 mit php-debugbar/php-debugbar v2.1.6 [#38660]
- Update symfony/polyfill-php8{2,3,4} auf v1.31.0 [#38661]
- Update lcobucci/jwt auf 5.3.0 [#38664]
- Update league/oauth2-server auf 9.2.0 [#38665]
- Update phpoffice/phpspreadsheet auf 4.2.0 [#38666]
- Update algo26-matthias/idna-convert auf 4.2.0 [#38667]
- Update caxy/php-htmldiff auf 0.1.16 [#38668]
- Update codeception/codeception auf 5.2.1 [#38669]
- Update edu-sharing/auth-plugin auf 8.0.x-dev 8ea462 [#38670]
- Update ezyang/htmlpurifier auf 4.18.0 [#38671]
- Update jumbojett/openid-connect-php auf 1.0.2 [#38672]
- Update laravel-json-api/neomerx-json-api auf 5.0.3 [#38673]
- Update league/oauth2-client auf 2.8.1 [#38674]
- Update nette/php-generator auf 4.1.8 [#38675]
- Update nyholm/psr7 auf 1.8.2 [#38676]
- Update oat-sa/lib-lti1p3-core auf 7.2.1 [#38677]
- Update opis/json-schema auf 2.4.1 [#38678]
- Update overtrue/phplint auf 9.6.2 [#38679]
- Update php-di/php-di auf 7.0.10 [#38680]
- Update phpseclib/phpseclib auf 3.0.43 [#38681]
- Update phpstan/phpstan auf 2.1.12 [#38682]
- Update psy/psysh auf 0.12.8 [#38683]
- Update slim/slim auf 4.14.0 [#38684]
- Update spomky-labs/otphp auf 11.3.0 [#38685]
- Update symfony/console auf 6.4.20 [#38686]
- Update symfony/process auf 6.4.20 [#38687]
- Update symfony/var-dumper auf 6.4.18 [#38688]
- Update symfony/yaml auf 6.4.20 [#38689]
- Update tecnickcom/tcpdf auf 6.9.3 [#38690]
- Update tuupola/cors-middleware auf 1.5.0 [#38691]
- Update vlucas/phpdotenv auf 5.6.1 [#38692]
- Updates der JS-Bibliotheken (Stud.IP 6.1) [#38695]
- Update altcha auf 1.4.2 [#38697]
- Update der babel-Bibliotheken [#38698]
- caniuse-lite in falscher Version in package-lock.json [#38711]
- VueApp::create - Cross Chunk Packages vermeiden durch Unterscheidung zwischen Komponenten und Apps [#38715]
- Zeitpunkt der Antwort in den Export der Fragebögen integrieren [#38721]
- `cli/studip`-Kommandos von Plugins [#38732]
- Veranstaltungs-Stundenplan für Admins: Anzeigefilter für Terminkachel einbauen [#38733]
- alte API zum Abfragen des Editorstatus entfernen [#38827]
- Fragebogeneditor kann keine Fragen hinzufügen [#38828]
- Forum 3 - Ungelesene Beiträge werden nicht vom alten Forum übernommen [#38844]
- Neue bzw. geänderte Icons für die 6.1 [#38847]
- Textstrings für die Übersetzung korrigieren [#38852]
- Forum - Offener Beitrag ("zitieren") und neuen Beitrag schreiben blockiert sich [#38863]
- Migration des neuen Forums setzt die Collation für manche Spalten falsch [#38872]
- Forum3: Ansicht letzte Beiträge fehlt [#38873]
- Forum3: Man kann nicht mehr sehen, wer genau einen Beitrag auf einen Beitrag reagiert hat [#38874]
- Löschen von Benutzern wirft Exception [#38876]
- Forum 3: Eigene Beiträge werden als neu angezeigt [#38887]
- Mechanismus einbauen, damit Verlinkungen zu Forenbeiträgen weiterhin funktionieren [#38888]
- Forum in freien Veranstaltungen sind nicht aufrufbar [#38889]
- Forum funktioniert nicht mehr an Einrichtungen [#38890]
- Fehler bei der Forum-Paginierung [#38895]
- Forum 3: Letzte Aktivität wird falsch gezählt [#38897]
- Forum 3: Die Übersicht der neuen Diskussionen hat keinen Hinweis auf die neuen Postings [#38898]
- Forum 3: Kein Anfasser für Sortierungen [#38900]
- Veranstaltungsverwaltung: Aktivieren und Deaktivieren von Tools wirft Fehler [#38901]
- Fehler in Wiki-Sidebar [#38911]
- theme.php nicht erreichbar [#38912]
- LayoutFehler nach Merge des Color-Themings [#38913]
- Autor darf keine neue Diskussion starten [#38918]
- Fehlerhafte Darstellung von Plugin-Icons, die kein SVG sind [#38919]
- JSON:API behandelt gelöschte Benutzer im Discussion-Schema [#38920]
- Forum 3: Linkformatierung ist nicht Standard [#38925]
- Wiki - Mobil komische Darstellung [#38926]
- Forum-Styles überarbeiten [#38927]
- Dynamische Links-/Rechts-Positionierung für Dropdown-Komponente [#38929]
- Dynamische Positionierung für Dropdown-Komponente [#38932]
- theme.php wird bei jedem Seitenaufruf neu erzeugt und geladen [#38933]
- Warnungen beim Webpack-Kompilieren [#38934]
- Forum: Globale Suche im Forum ist kaputt [#38938]
- Forum 3: "Aktivitäten" sollte "Letzte Aktivität" sein [#38940]
- Forum 3/OpenGraph: Leere Objekte sollen nicht angezeigt werden [#38941]
- Forum 3: OpenGraph-Bereich sollte deutlich kleiner [#38942]
- Forum 3: Zitieren aus Markierung springt Antworten-Formular nicht an [#38943]
- ILIAS-Schnittstelle: Type-Error bei Abfrage der Arbeitsbereiche [#38947]
- Im Wiki sind die Icons der Contentbar verschoben [#38949]
- Forum verwendet falsche Rechteabfragen in der JSON-API [#38952]
- Abweichende Farbwerte durch ColorTheming Variablen [#38954]
- Forum: Viele Routen in der API verwenden nicht die Authority [#38957]
- Forum: Speichern der Inhalte umgeht den HTML-Purifier [#38958]
- Forum: Bearbeiten eines Beitrags fügt jedesmal ein `<div>` hinzu [#38959]
- JSON-API: UserSchema wirft Fehler bei unauthentifiziertem Nutzer [#38975]
- Theming: Farbe des Textes in Fehlermeldung ist falsch [#38986]
- Forum 3: Textfehler im Adminbereich [#38990]
- Forum 3: Iconauswahl passend stylen [#38991]
- Theming/Styling: Problem mit unterstrichenen Links [#38992]
- Forum: Anonyme Beiträge müssen anonyme Benachrichtigungen schicken [#39007]
- Forum3: Forumskonfigurationen von Veranstaltungskategorien entfernen [#39013]
- Forum: PHP-Warning beim freien Veranstaltungen [#39014]
- Forum: Icon in Veranstaltungsübersicht zu oft rot [#39015]
- Hinweis zur Variable $MAIL_ATTACHMENTS_MAX_SIZE hinzufügen [#39018]
- Docker Images starten nicht mehr korrekt: 'unconnected' user: 'unauthenticated' host: 'IP: X.X.X.X' [#39031]
- Forum: Das Markieren neuer Beiträge als gelesen funktioniert nicht [#39035]
- Forum 3: Unterseite "Abonnierte Diskussionen" hat falschen Titel ("Abonnent:innen") [#39037]
- Forum 3: Diskussion-Footer erhält keinen linken roten Rand, wenn er zwischen neuen Beiträgen liegt [#39040]
- Vue Komponente: StudipSelect -  funktioniert schlecht, wenn das Item einen langen Namen hat und beim Auf- oder Zuklappen [#39043]
- Pipeline: Probleme bei Änderungen an durch PHPStan exkludierten Dateien [#39044]
- Leeres Wiki erzeugt SyntaxError auf der Browserkonsole [#39059]
- Kleine Glitches im Layout [#39060]
- Öffentlich zugängliche Raumpläne funktionieren nicht mehr [#39063]
- Raumsuche: Öffentlich zugänglicher Belegungsplan wird für Personen ohne Raumberechtigungen nicht angezeigt [#39064]
- CKEditor: Scrollen führt immer zusätzliche CSS-Regeln hinzu [#39072]
- Sidebar Toggle der Kompakten und Responsiven Ansicht hat falsche Icon-Farbe [#39075]
- Forum 3: Diskussion – Ladezeit reduzieren [#39204]
- Forum: Kleiner Rechtschreibfehler bei "Beitrag weiterleiten" [#39213]
- Forum: Kleiner Rechtschreibfehler beim Löschen eines Beitrags [#39214]
- Forum: "Antworten" Button [#39345]
- ILIAS-Schnittstelle: Prüfung nach bestehender Einrichtung schlägt fehl [#39347]
- Forum: Variablennamen und Typdeklarationen aktualisieren [#39364]
- Forum: Falsche HTML-Semantik — WYSIWYG-Text (Zitat-Inhalt) darf nicht mit <a>-Tags umschlossen werden [#39370]
- ILIAS-Schnittstelle: Kategoriename lässt sich nach erster Eingabe nicht mehr anpassen [#39378]
- Forum 3: Klickbare Elemente verlieren blaue Farbe [#39382]
- Löschen von Auswahl-Optionen bei Fragebögen ist nicht mehr per Tastatur ansteuerbar [#39391]
- Meine Veranstaltung zeigt Veranstaltungen doppelt und dreifach an [#39415]
- ResponsiveNavigation in der mobilen Darstellung kaputt [#39421]
- Layout in Block-Suche der Courseware stimmt nicht [#39425]
- Aktivitätenwidget: Icons nicht sichtbar [#39432]
- Fehlerhaftes CSS für .actions Tabellenzellen mit SVG [#39451]
- Verwaiste Konfigurationseinstellungen entfernen [#39456]
- Icons haben falsche Größen und Positionen [#39501]
- Neues Forum hat noch keine Tour [#39522]
- Forum: Avatargruppe hat Darstellungsfehler [#39526]
- "Houston, we've got a problem" hat die falsche Schriftfarbe [#39528]
- X in Vue Dialogen hat zu wenig Padding [#39531]
- Forum: Reactions können doppelt angelegt werden [#39534]
- Wiki: Löschen in Tabellenansicht löscht die falsche Seite [#39539]
- SelectWidget - multiple: GUI buggy [#39545]
- Diskussion ohne Beitrag wird nicht angezeigt [#39557]
- Grafikfehler beim Zuweisen/Entfernen von Lehrenden zu Terminen [#39558]
- Forum: Refactoring CSS [#39559]
- MVV: Modulbearbeiten - Language Chooser kaputt [#39566]
- Vue-Komponente: StudIPSelect -  Dropdown-Icon vereinheitlichen [#39573]
- Forum: Beim Bearbeiten einer Diskussion werden ausgewählte Tags doppelt gespeichert [#39574]
- Forum: Refaktorierung der  Kategorie, Topic und Diskussions Metadaten sowie Behebung der fehlerhaften Anzeige ungelesener Beiträge [#39575]
- Semantische Inkonsistenz bei Buttons im Forum 3 [#39588]
- Falsche Zuordnung von ARIA-Attributen im Kontextmenü des Forum 3 [#39589]
- Invalides html im action-menu [#39593]
- Farbschema: Filter-Markierung in der Sidebar ist falsch [#39610]
- ckeditor heading dropdown hat falsche Textfarbe [#39613]
- VueApp mit `withPlugins` schlägt fehl [#39616]
- Studiengruppen: Angezeigte Anzahl immer 1, Pagination fehlt [#39644]
- Falscher Typ für die Konfigurationseinträge des Stundenplans [#39646]
- Release Notes der 6.0 sind in >= 6.1 nicht vorhanden [#39687]
- Falsche Nummerierung für Migration 6.1.17 [#39690]
- Icon::asSvg() kann nicht mit Attribut 'style' umgehen. [#39691]
- Speichern-Button im Forum mit falschem Icon [#39697]
- Neues Forum Polishing [#39713]
- Avatar-Menü: Barrierefreiheitsprobleme beheben [#39716]
- MVV-Studiengangsteilabschnitte-Ansicht im Vorlesungsverzeichnis [#39720]
- Forum3: A11y [#39730]
- Benuzerdefinierte Farben lassen sich nicht anlegen [#39736]
- Fehler beim aktivierten Forum in einer Einrichtung [#39738]
- MVV: Modulübersicht zeigt verknüpfte Veranstaltungen aus allen Semestern [#39781]
- ILIAS-Schnittstelle: Deselektieren von Modulen im Admin-Dialog wird nicht gespeichert [#39802]
- Forum: Hilfelasche und Link zur Hilfe [#39807]
- Farben/Theming: Kopfzeile und Dialogkopfzeile haben nicht den gleichen Farbwert [#39810]
- MVV: Modul-Kurzdarstellung im VVZ [#39820]
- PHP8-Fehler MVV-Modulbeschreibung [#39822]
- Migration für die 6.2 ist in der 6.1 gelandet [#39824]
- ILIAS-Schnittstelle: getUserRoles wirft TypeError, wenn SOAP-Abfrage fehlschlägt [#39843]
- ILIAS-Schnittstelle: Anzeige von Arbeitsbereichen in Navigation und Arbeitsplatz auch unterhalb von tutor [#39844]
- ILIAS-Schnittstelle: Warnings, wenn Schnittstellenkonfiguration nicht abgeschlossen [#39851]
- Forum3: Rendering der Kategoriebeschreibung ist fehlerhaft [#39880]
- Bestätigungsdialog bricht falsch um [#39883]
- OER-Campus: Icons nicht blau [#39892]
- Anderes Icon für "Anzahl der Beiträge" im Forum verwenden [#39899]
- Fehlende Funktionen in HeadlineBlock [#39905]
- Falsche Benutzung von $gettext [#39909]
- PHP-Exception in Nachrichten an Zielgruppen [#39914]
- Icon::asImg() sollte das Standardverhalten implementieren [#39926]
- Icon-Buttons nicht mehr per Tastatur bedienbar [#39929]
- Typo in Datei tables.scss [#39952]
- Icon zum Anzeigen/Verstecken des Passworts ist nicht mehr blau [#39957]
- SVG-Icons ohne viewbox-Attribut können das Layout von "Meine VA" sprengen [#39960]
- Fehlerhafte Darstellung der Hauptnavigation, wenn sie umbricht [#39961]
- Tab selektiert Button-Elemente im Aktionsmenü doppelt [#39963]
- Raumanfragen: Auswahl des Raumtyps funktioniert nicht mehr [#39968]
- Raumverwaltung: Administration > Kategorien verwalten , Eigenschaften können nicht mehr ergänzt werden [#39970]
- Responsives Layout hat schlechtes Alignment [#39971]
- Aktionsmenü öffnen sich falsch und werden abgeschnitten [#39977]
- MVV: Semesterfilter in Modulsuche defekt [#39980]
- Löschen einer individuellen Raumgruppe [#39986]
- MVV: In der Modulübersicht werden auch die Namen von versteckten Veranstaltungen angezeigt [#39989]
- Headline Block skaliert Hintergrundbild nicht [#40002]
- Belegungsplan: Rüstzeit nach der Buchung sorgt für Fehler im Belegungsplan [#40026]
- Gruppen: doppelter Aufklapppfeil bei Gruppennamen [#40053]
- Forum\Posting::getRecentPosts() performt sehr schlecht [#40071]
- Fehler bei den täglichen Benachrichtigungen [#40089]
- Forum: Neuer Beitrag geht sofort verloren, wenn neben Dialogfenster geklickt wird. [#40110]
- Forum3: "Diskussion schließen" im Diskussionsformular umbenennen [#40115]
- Admin -> Standort -> Darstellung: Hexcodes für Farbwerte können nicht eingegeben werden [#40129]
- Optionen zum Abonieren von Themen und Diskussionen im Forum unklar beschriftet [#40130]
- Forum: Button zum Antworten ist mit "Speichern" beschriftet [#40139]
- Icon-Navigation der Veranstaltungen zeigt immer das gleiche Modul [#40141]

# 22.04.2026 v 6.0.3

https://gitlab.studip.de/studip/studip/-/issues?milestone_title=Stud.IP+6.0.3&state=all
- Courseware: ZIP-Export bzw. PDF-Export einer verknüpften Seite exportiert nur leere Seiten [#33792]
- Wiki: Responsive Bearbeiten setzt WYSIWYG-Leiste beim Scrollen falsch [#39066]
- Exception in den neuen Aufgaben [#39518]
- Hohen Kontrast aktivieren und Sprachauswahl funktionieren nur auf Login Seite [#39596]
- Plugins können sich nicht mehr so einfach in VA-Navigationen einhängen [#39829]
- Fehler beim Belegungsplan für Nobody [#39840]
- Export von Raumbuchungen: Mehrtägige Termine sind in den exportierten Daten nicht sichtbar [#39857]
- SQL-Bug in der Courseware [#39918]
- JSON-API: Self-Links in `/datafields` sind kaputt [#39933]
- Holidays getHolidayId ist privat [#39944]
- Anzeige des Schliessen-Buttons bei den Systembenachrichtigungen bringt ggf. viel Unruhe [#39958]
- Meine Seminar: Veranstaltungsnummern werden doppelt angezeigt [#39959]
- PHP Warning:  Undefined array key "id" in /var/www/studip-6.1/lib/classes/JsonApi/Routes/Courseware/UserProgressesOfUnitsShow.php on line 74 [#39966]
- Schlecht performendes Query im `MyStudygroups`-Controller [#39967]
- Adminübersicht Veranstaltungen : Gebuchte Räume bei Einzeltermine werden nicht angezeigt [#39969]
- CourseDateList::toHtml() zeigt immer Raumnamen bei regelmäßigen Terminen an [#39976]
- HandleAccessDeniedMiddleware leitet immer auf Login/Startseite um [#39979]
- Ermittlung der vorgeschlagenen Studiengruppen immer noch zu langsam [#39981]
- Migration VIPS-Aufgaben fehlt die Verknüpfung von den CW-Test-Blöcken [#39982]
- Zeiten/Räume: Änderungen für #4030 wurden wieder ausgebaut [#39983]
- Bevorzugung höherer Fachsemester wird nicht angezeigt [#39988]
- PHP 8 MVV-Perm Warning [#39990]
- Aufgaben: Export von Abgabeprotokolle [#40014]
- Veranstaltungen im Stundenplan lassen sich nicht anklicken [#40020]
- Teilnehmende nach Gruppen: Aktion »Austragen aus der Veranstaltung« ohne Auswirkungen [#40052]
- XSS-Schwachstellen auf der Teilnehmerseite [#40058]
- Datumsfehler bei den Log-Einträgen [#40060]
- Call to undefined function raumzeit_send_cancel_message() [#40062]
- Raumverwaltung: Export der Teilnehmendenzahl wirkt sich auf nachfolgende Zeilen aus [#40065]
- Ausblenden von Tagen im Stundenplan verschiebt die VA-Termine [#40068]
- Fehler bei Terminänderungen mit gebuchten Räumen [#40075]
- Lehrender kann nicht herabgestuft werden, ... obwohl er das gar nicht soll [#40079]
- Anmeldeset: Fehler bei der Regel "Bedingte Anmeldung" [#40080]
- Fehler beim Bearbeiten von mehreren Terminen [#40081]
- Manuelle Buchung: Serientermine überschreiben Reservierungen ohne Meldung [#40082]
- Farbgruppierung von einer Veranstaltung aus aufgerufen ist defekt [#40087]
- Raumgruppen-(Semester-)Belegungsplan: In der Sidebar ist immer die erste Gruppe ausgewählt [#40092]
- Farbgruppierung ändern bei Studiengruppen nicht möglich [#40109]
- Export von Raumbuchungen: Mehrtägige Termine werden komplett exportiert [#40111]
- Browser-Warnung beim Schliessen ist zum Teil zu aggressiv [#40117]
- Beim Bearbeiten von Wiederholungsbuchungen steht das Wiederholungsintervall immer auf „täglich“ [#40118]
- Tools Exceptions nicht per Autoload geladen [#40120]
- Übersetzungen in v6.0 defekt [#40121]

# 22.04.2026 v 5.5.9

https://gitlab.studip.de/studip/studip/-/issues?milestone_title=Stud.IP+5.5.9&state=all
- Fehler beim Anklicken eines Termins im Einrichtungsstundenplan [#39193]
- Terminkalender: Termin mit monatlicher Wiederholung an einem Wochentag erhält beim Bearbeiten anderer Eigenschaften eine andere Wiederholung [#39938]
- UNI_LOGOUT_ADD kann kein Array mehr sein [#39954]
- MVV: Suche nach Materialen/Dateien kaputt [#39972]
- MVV: Falsche Ausgabe der Studiengangteilabschnitt-spezifischen Modul(teil)-Bezeichnungen [#39973]
- Fehler "Zugriff verweigert" beim Aufruf des Veranstaltungsstundenplans einer Einrichtung [#39996]
- Kalender: "DivisionByZeroError: Modulo by zero" bei Terminen ohne Wiederholungsintervall [#40011]
- MVV: Material/Dokumente werden nicht angezeigt. [#40019]
- Belegungsplan: Letzter Termin einer Wiederholungsbuchung geht verloren, wenn die Buchung per Drag & Drop nach unten geschoben wird [#40025]
- Anzeige der Modulinformationen auf der Veranstaltungsdetailseite ist in 5.5 kaputt [#40066]

# 22.04.2026 v 5.4.12

https://gitlab.studip.de/studip/studip/-/issues?milestone_title=Stud.IP+5.4.12&state=all
- Sperrbuchung kann angelegt werden, auch wenn keine Rechte dafür vorhanden sind [#33673]
- Leerer Abschnitt auf erster Seite im Lernmaterial [#36079]
- Datei aus dem OER-Campus in Veranstaltung einfügen führt zu leerem Dateinamen [#39541]
- Fehlender Primärschlüssel in files_search_index führt zu Problemen bei Datenbankreplikation [#39733]
- JSON-API: Relation `sub-institutes` an einer Einrichtung ist kaputt [#39748]
- Upload und Download verbotener Dateitypen durch URLencodierte Dateinamen [#39773]
- Drag & Drop der Prioritäten funktioniert nicht mehr nach Scrollen [#39908]
- Art des Termins wird überschrieben bei Stapelverarbeitung von Terminen [#39937]
- Tabellenzeilen werden nur beim Hover aber nicht bei Tastaturbedienung eingefärbt [#39943]
- Menü in der Hauptnavigation nicht per Tastatur bedienbar [#39962]
- JSON-API: Liste der Einrichtungen eines Mitarbeiters nicht abrufbar [#39975]
- Fehler beim Löschen mehrerer Nutzer: count() ... [#40027]
- Courseware: Beim Importieren wird zu jeder Seite ein leerer Abschnitt hinzugefügt [#40032]
- JSON-API: Standardeinrichtung des Nutzers nicht markiert [#40033]
- JSON-API: Im Schema für `courses` fehlen die Links in den Relationen `sem-type` und `sem-class` [#40038]
- PersonalNotifications löscht nicht die Relation zu PersonalNotificationsUser [#40054]
- Export von Raumbuchungen: Veranstaltungsangaben stehen alle in einem Feld [#40061]
- Gelöschte Semester_id als MY_COURSES_SELECTED_CYCLE erzeugt Fehler [#40069]
- SQL-Injections [#40112]
- Dateien mit Sonderzeichen im Namen heißen nach Download "sendfile.php" [#40113]
- Raumanfrage erstellen: Button „Raum auswählen“ ist bei einer langen Raumliste wegen verschachteltem Scrollen nicht sichtbar [#40125]
- Semesterbezug fehlt in der täglichen Benachrichtigung [#40126]
- MultiPersonSearch: Problem beim Setzen von DefaultSelectedUsers [#40140]

# 27.02.2026 v 6.0.2

https://gitlab.studip.de/studip/studip/-/issues?milestone_title=Stud.IP+6.0.2&state=all
- Courseware: Fortschrittsanzeige wird nicht aktualisiert [#35587]
- Courseware: Freigaben werden nicht angezeigt [#37707]
- Neues Formular-CSS überschreibt "max-width" für Elemente im Fieldset [#38092]
- Stundenplan: Nachladen der Termine dauert zu lange [#38603]
- Courseware: Freigaben werden wegen vue-router nicht angezeigt [#38763]
- OpenID Connect: Auth-Plugin braucht Id Token zur Abmeldung [#38866]
- Raumgruppen-Belegungsplan zeigt keine Buchungen an [#39197]
- JSON-API liefert zu viele Daten bei der Veranstaltungssuche [#39398]
- Fehlende Sortierung bei den verknüpften Veranstaltungen innerhalb eines Anmeldesets [#39403]
- Falscher Property-Name beim Bearbeiten von Massenmails [#39405]
- Tages-Navigation im Stundenplan [#39409]
- Suche Admin-Veranstaltungen funktioniert nicht [#39412]
- Syntax Error beim Speichern der Gruppierungen auf Meine Veranstaltungen [#39417]
- Middleware TrailingSlash macht Aufrufe kaputt [#39418]
- PHP-Warnungenin MyCoursesHelper [#39419]
- Die Veranstaltungsnummer fehlt im Context-Titel [#39422]
- lib/cronjobs/studygroup_expiration.class.php wurde nicht in der Datenbank umbenannt [#39424]
- Seiten lassen sich in der Courseware nicht verschieben [#39428]
- JSONAPI: falsche Klasse in /v1/degrees [#39434]
- JSONAPI.withPromises ist nicht via TypeScript nutzbar [#39448]
- Nachricht mit den OAuth2-Secrets eines Clients wird flüchtig dargestellt [#39455]
- Tippfehler beim Aufruf von $gettext [#39457]
- isActivated Aufruf auf CoursewareBlock nicht möglich [#39458]
- Direktive v-autofocus ist defekt [#39459]
- Interne Links im ImageMap Block funktionieren nicht [#39461]
- Lange Wiki-Seiten führen zu starker Eingabeverzögerung [#39471]
- ILIAS-Schnittstelle: Account-Zuordnung in Benutzerverwaltung funktioniert nicht für Loginnamen mit Sonderzeichen [#39473]
- Aufgaben in Courseware: Dateiupload nicht möglich [#39474]
- Courseware: Rechte und Sichtbarkeit - Fehler beim Zeitraum [#39496]
- Courseware - Zeiträume für die Sichtbarkeit verwirrend und funktionieren nicht richtig [#39500]
- Aufgabenkorrektur wird nicht übernommen [#39507]
- Vue-App "ConsultationCreator" nutzt unnötigerweise transitive Abhängigkeit "moment" [#39565]
- Nachricht beim erstellen eines Accounts fehlerhaft [#39579]
- UserConfig::get(): Furchtbare Performance [#39590]
- ILIAS-Schnittstelle: Suche von Lernobjekten nur für zuerst angebundene ILIAS-Instanz [#39603]
- Aktionen im Bilder-Pool lassen sich nicht auslösen [#39617]
- Fehler bei Detailansicht von Stud.IP Veranstaltung aus ILIAS Kursansicht heraus [#39618]
- Wikiseiten, die ohne WYSIWYG-Editor geschrieben wurden, haben nach dem Speichern ihre Formatierung verloren [#39619]
- Wiki: Anzeige von aktuellen Änderungen anderer Nutzer funktioniert nicht [#39632]
- SORM-Ausgaben in `cli/studip tinker` lesbar machen [#39633]
- AdmissionApplication: Call to undefined method Course::getName() [#39637]
- Tagesansicht im Stundenplan blättert über die eingestellte Woche hinaus [#39642]
- Falscher Typ des Konfigurationseintrags ENABLE_NUMBER_OF_PARTICIPANTS [#39645]
- Stundenplan: Farben im Auswahldialog sollten vollen Farbton zeigen [#39650]
- Zeitgesteuerte Inhalte werden nicht sichtbar [#39654]
- JSON-API: ModulesIndex - Filter nach Module-stat [#39661]
- Sprechstunden: Termine und Terminblöcke [#39668]
- iCal-Import schlägt fehl für das Feld "Trigger" [#39674]
- iCal-Import schlägt fehl für Ganztagstermine [#39675]
- iCal-Import schlägt fehl bei Wiederholungsterminen [#39676]
- Aufgaben lassen sich nicht öffnen [#39682]
- Fehlende Anmelderegeln führen zu Exception [#39688]
- ILIAS-Schnittstelle: Inkompatibilität mit ILIAS 10 [#39706]
- DebugBar kann nicht korrekt mit mehreren gleichen Studip\VueApps umgehen [#39712]
- PHP-8 Fehler bei Aufgaben aka VIPS [#39717]
- Die LTI-1.1-Integration funktioniert seit 6.0 nicht mehr. [#39723]
- Fehler in 6.0.34_add_dummy_teacher.php [#39728]
- Tagesansicht im Stundenplan kann nicht ausgewählt werden, wenn der aktuelle Tag unsichtbar geschaltet wurde [#39766]
- LTI: Warum nur mit 1.3a  globale LTI-Konfiguration möglich? [#39777]
- LTI 1.1: Fehler beim Exportieren der Ergebnisse [#39778]
- index.php sollte GET-Parameter durchreichen [#39796]
- Exception beim Login [#39798]
- Diverse Seiten sind nicht mehr ohne Login aufrufbar [#39811]
- Admine / Meine-VA - Regelmäßige Termine werden nicht angezeigt [#39823]
- Fehlermeldung beim Auflösen von Raumanfragen [#39828]
- Courseware ermittelt die Blöcke einer Instanz nicht korrekt [#39830]
- LTI 1.3a: User-Roles wird beim Launch nicht korrekt übermittelt [#39836]
- Aufgaben: Korrektur zeigt aktuelle Version doppelt in der Liste an [#39845]
- XSS-Schwachstelle bei den Terminangaben einer Veranstaltung [#39852]

# 27.02.2026 v 5.5.8

https://gitlab.studip.de/studip/studip/-/issues?milestone_title=Stud.IP+5.5.8&state=all
- Wiki: Kein Aktionsmenü in Tabellenansichten [#31116]
- jQuery Zeitwähler:: Kontraste nicht optimal [#37300]
- Wiki: Inhaltsverzeichnis wird nicht mehr angezeigt [#37315]
- Wiki: Erste Seite die angelegt wird muss Wiki-Startseite sein [#38192]
- Export: Datenfelder fehlen im Teilnehmerexport von Gruppen [#38871]
- Wiki: Löschen der Startseite führt in inkonsistenten Zustand [#39053]
- Wiki: Löschen von Seiten hinterläßt verwaiste IDs in der DB [#39055]
- Wiki-Startseite-Umbau [#39441]
- Bearbeitungsmodus des ImageMap Block funktioniert nicht [#39460]
- "Beobachtungen" bei Migration von 5.3. zu 6.0 [#39564]
- Courseware Aufgaben - Verlängerungen werden falsch gespeichert [#39621]
- Wiki in Einrichtungen ist kaputt [#39698]
- Aufruf der Startseite in 5.5 führt zu Exception [#39732]
- Nutzen von RangeConfig führt zu Problemen [#39740]
- Warning in der CoreWiki Navigation [#39757]

# 27.02.2026 v 5.4.11

https://gitlab.studip.de/studip/studip/-/issues?milestone_title=Stud.IP+5.4.11&state=all
- Vorlesungsverzeichnis: Suche findet keine Dozenten mehr [#34231]
- Fragebögen: Export als PDF ist kaputt und/oder exportiert falsche Daten [#34590]
- Neue ILIAS-Installation hinzufügen kaputt (Stud.IP lügt) [#38129]
- In der Mail zum Löschen von Buchungen von Ressourcen taucht der Satz „Die Löschung wurde von vorgenommen.“ auf, wenn die löschende Person nicht bekannt ist [#38140]
- Externe Seiten: Umschalten der Sprache wirkt sich nicht auf alle Inhalte aus [#38333]
- Unsichtbare Courseware-Seiten sind erreichbar aber leer [#38716]
- Courseware: Galerie-Block läßt sich nicht mehr speichern [#38756]
- Schnellzugriff: "Neue Veranstaltung anlegen" öffnet keinen Dialog [#39184]
- Profilbild/Avatar ändern erlaubt nur die Nutzung der Kamera [#39390]
- Eingabefelder wenden `required`-Attribut auf alle Sprachen an [#39396]
- Cronjobs doppelt registriert in CLI [#39400]
- PHPStan in der Pipeline kennt die Klassen der CLI-Kommandos nicht [#39401]
- Erkennung von ausgefallenen Termin in JSONAPI-Route fehlerhaft [#39436]
- Courseware prüft den FolderType nicht [#39438]
- Fehlerhafter Zugriff auf Id-Variable im OAuth2-Client [#39449]
- Dateien aus Abgabeordnern in der Globalen Suche bei Stud.IP sichtbar [#39450]
- PDF-Export von Fragebögen mit vielen Fragen bringt den Browser aus dem Takt [#39452]
- Meine VA - Mobile Darstellung zeigt die Veranstaltungsnummer nicht an [#39453]
- Nutzer werden beim Löschen benachrichtigt [#39462]
- Profilseite: Pfeile zum Verschieben der Einrichtungen haben keine Funktion [#39466]
- Globale Suche ist defekt [#39467]
- ToolActivation::setVisibilityPermission() ist kaputt [#39478]
- Unterbrochenes Wort im Mailtext beim manuellen Eintragen in Veranstaltungen [#39483]
- Courseware - Videoblock funktioniert nicht richtig [#39497]
- Zusätzliche Zeichen (?>) hinter Einrichtungstiteln [#39502]
- Bilder im Galerie-Block werden bei geänderter Auflösung/Skalierung und in mobilen Ansichten nicht korrekt dargestellt [#39503]
- Nutzendenverwaltung: Passwortmanager springt auf Nutzendensuche an [#39508]
- Exception in den Sprechstunden [#39519]
- Fragebögen: PDF-Export der Auswertung funktioniert nicht [#39536]
- Anzeigefehler in Modulbeschreibung bei Modulen ohne Modulteil [#39538]
- Der OER_PUBLIC_STATUS wird nicht überall respektiert [#39540]
- Falsche Log-Aktion bei Änderung der E-Mail-Adresse [#39554]
- Vue Komponente: Dialog-Backdrop vereinheitlichen [#39571]
- Fehler beim Export/Import von Lernmaterialien [#39572]
- Anlegen von Unterordnern funktioniert nur mit offiziellen Dateibereichen [#39615]
- Externe Seiten: Vererbung von Rollendaten funktioniert nicht bei mehrsprachigen Datenfeldern [#39626]
- PageLayout::disableHeader() führt zu Fehlermeldungen im Wysiwyg-Editor [#39630]
- institute/overview macht bei `redirect_to` nicht mehr (immer) einen Redirect [#39657]
- JSON-API: Institute-Schema fehlt "type"-Spalte [#39660]
- PHP 8 Fehler bei MVV-Versionen [#39677]
- Bearbeiten einer Raumanfrage, falsche Hinweis bzgl. Sitzplätze [#39679]
- PHP 8 Fehler bei der Courseware [#39714]
- MVV-Studiengangsteil-Abschnitt Bearbeiten [#39721]
- PHP8-Fehler bei Ansicht Veranstaltungs-Stundenplan [#39739]
- Dateibereich visualisiert nicht, welche Dateiquelle man gerade betrachtet [#39756]
- Fehlerhafte URLs bei der Verwaltung der Einrichtungshierarchie [#39758]
- JSONAPI: Courses-Authority erlaubt Root nicht das Auslesen der Kurse einer Person [#39762]
- Veranstaltungs-Avatar wird nicht auf der Übersichtsseite angezeigt [#39784]
- Nachrichten bzgl. Positionsänderungen auf der Warteliste werden auch für vergangene VA verschickt [#39785]
- Verwaltung von Veranstaltungen: Spalte "Raum/Zeit" zeigt Termine aus allen Semestern an [#39797]
- PHP8 Fehler bei der Raumverwaltung [#39800]
- ILIAS-Schnittstelle: Deselektieren von Modulen im Admin-Dialog wird nicht gespeichert (<= 6.0) [#39806]
- Zugriff auf Inhalte in freien Veranstaltungen nicht mehr möglich [#39814]
- Löschen von LogActions führt ggf. zu Memory Limit Error [#39862]
- ILIAS-Schnittstelle: Aufruf von GetRole führt zu Fehlermeldung [#39869]
- "Alles als gelesen markieren" braucht einen Dialog [#39871]
- Kaputte Belongs-To Relationen in SimpleORMap [#39878]
- lib/browse.js wird nicht mehr verwendet [#39884]
...
- Teilnehmerlisten nach Namen sortiert exportieren [#4763]
- Ausgabe der Studiengangsbezeichnung ist abgeschnitten [#4816]
- Terminübersicht zeigt freie Ortsangabe trotz Raumbuchung [#4836]
- Excel-/CSV-Export von Teilnehmergruppen unvollständig [#4837]
- Im Stundenplan ausgeblendete Veranstaltungen werden im Widget „Meine aktuellen Termine“ angezeigt [#4866]
- Wiki Berechtigungsprobleme bei Einrichtungen und freien Veranstaltungen [#5153]
- Bearbeitung von Wiederholungsterminen funktioniert nicht [#5181]
- Vorlesungsverzeichnis: Der Filter nach einer Veranstaltungskategorie liefert keine Ergebnisse [#5243]
- Type Hinting für SimpleCollection-Inhalte [#5257]
- Export: Reihenfolge der Personen der Einrichtung ist "zufällig" [#5259]
- Wiki: Auf jeder Seite wird "Wiki-Startseite" als aktiver Navigationspunkt angezeigt [#5276]
- Courseware: Im »Audio«-Block »Audio-Aufnahmen zulassen« ist kaputt [#5294]
- Funktion CalendarDateAssignment::getRoomName() existiert nicht [#5339]
- WIKI_COURSE_EDIT_RESTRICTED wird nicht mehr benötigt [#5342]
- Skandal: Stud.IP Punkte verschwunden [#5385]
- Fehlermeldung beim Teilnehmerexport über Admin-Veranstaltungsadministrationsseite [#5395]
- Veranstaltungsverwaltung: Teilnehmerexport funktioniert für einige Veranstaltungen nicht [#5396]
- Aufrufen der Profilseite erzeugt Unmengen an DB Abfragen [#5410]
- SCSS-Compiler bindet CSS-Variablen mehrfach ein [#5411]
- Exporte verwenden die falschen Spaltentrenner im CSV [#5439]
- Export: Datenfelder fehlen im Teilnehmerexport [#5440]
- Terminvergabe: abgesagte Termine bleiben in der Datenbank [#5462]
- Stundenplan: Start- und Endzeit wird ignoriert [#5470]
- Wiki-Kommentare funktionieren nicht mehr [#5511]
- Terminvergabe: Nach dem Löschen einer Person werden Benachrichtigungsmails für deren gebuchte Termine in der Vergangenheit verschickt [#5561]
- Hinweistexte auf Loginseite machen Links nicht kenntlich [#5581]
- Export: Zusatzangaben fehlen im Teilnehmerexport [#5610]
- Export: Datenfelder fehlen im Teilnehmerexport von Gruppen [#5616]
- Export: Teilnehmerexport in LV ohne Zusatzangaben kaputt [#5657]

# 26.06.2025 v 5.4.8

https://gitlab.studip.de/studip/studip/-/issues?milestone_title=Stud.IP+5.4.8&state=all
...
- Dialoge: size=auto beachtet Fragezeichen nicht [#5046]
- PHPWarnings [#5340]
- Rollenverwaltung: Personen-Tabellen der jeweiligen Rolle sind nicht vorsortiert [#5378]
- Veranstaltungsexport aus dem VVZ ohne Bereichspfad und mit falscher Liste der Lehrenden und HTML-Fragmenten [#5400]
- Blubber: (vermutlich) unnötige Queries [#5420]
- Globale Suche: Direkter Aufruf mit Suchbegriff als Parameter in der URL funktioniert nicht (immer) [#5445]
- Veranstaltungen über Einrichtung belegen funktioniert nicht. [#5457]
- CI: eslint-formatter-gitlab ab Version 6 führt zu Konflikt und somit zu fehlerhafter Pipeline [#5523]
- Blubber: countUnreadComments zählt falsch [#5597]
- Ilias Schnittstelle: studip_referrer.php springt nicht mehr in Ilias Objekte (Ilias 8) [#5617]
- BlubberThread::findMyGlobalThreads nicht sonderlich performant [#5628]
- Blubber-Suche in Veranstaltungen führt zu Fehlermeldung [#5644]

# 26.06.2025 v 5.3.11

https://gitlab.studip.de/studip/studip/-/issues?milestone_title=Stud.IP+5.3.11&state=all
- Sehr viele Aufrufe von RoomManager::userHasRooms() [#343]
- Forum - Letzte Beiträge - Zitieren auf Bereiche [#1769]
- Forum - Bereich editieren lässt sich mehrfach öffnen [#1957]
- Spaltenüberschriften im Dialog "Raumeigenschaften" nicht sinnvoll [#3056]
- Raumverwaltung Administration: Berechtigungsübersicht zeigt nur Buchungen mit der Person als Belegender [#3778]
- Fragebogen: Es landen doppelte Anworten zu einem Nutzer in der Datenbank [#3802]
- Weitere PHP8-Warnungen [#4832]
- ILIAS-Schnittstelle: Inkompatibilität mit ILIAS 9 [#4995]
- Raumanfragen: Raumliste bei "Auswahl anhand einer Raumgruppe" ist nicht sortiert [#5110]
- Semesterbelegungsplan zeigt falsches Semester an [#5240]
- Timeout bei großen Blubber Threads [#5313]
- Datenfelder lassen sich nicht anlegen [#5335]
- Diverse Warnings im Ilias Interface [#5344]
- PHP-Warning in course/grouping/members [#5348]
- Nutzendenverwaltung: Forms sind falsch ausgerichtet [#5349]
- Sortierung der Statusgruppen ist defekt [#5356]
- Fehlende Bestätigung beim Zurücksetzen der Startseite [#5357]
- Externe Seiten: Speichern der Grundeinstellungen führt zu Fehler (PHP 8) [#5376]
- Eingabefelder mit Select ("nested-select") verlieren den Fokus [#5381]
- Problem mit PDO::ATTR_STRINGIFY_FETCHES [#5382]
- Löschen von Cronjob rennt in memory limit [#5386]
- Probleme mit get_default_http_stream_context() und Proxy [#5388]
- Weitere PHP8-Warnungen [#5399]
- CW: Text-Block (Halbe-Breite) schneidet den CKEditor ab [#5403]
- Aufrufen der Veranstaltungsübersicht erzeugt unnötig DB-Abfragen für Termine [#5421]
- SimpleORMap::setData() iteriert immer über alle Werte im Objekt [#5422]
- Fehlerhafte Darstellung bei der Anmelderegel: "Kurs mit Teilnahmebedingungen" [#5427]
- Formatierungsfehler in Warnmeldung - Thema Löschen Forum [#5429]
- Unload event listeners are deprecated and will be removed. [#5436]
- PHP8-Warnungen [#5441]
- Logout über Shibboleth: Informationen gehen verloren [#5460]
- CKE v4 immer noch im Code [#5473]
- Terminvergabe: Fehlerhafte Zuordnung von verantwortlichen Personen zu Terminen [#5475]
- Stylesheets von CKE4 können entfernt werden [#5477]
- Auslesen der Konfiguration erzwingt bei jedem Seitenaufruf ein filesort [#5492]
- Dateigrößen in Byte Größe haben fehlerhafte Pluralform [#5512]
- Courseware: Aufgaben verteilen bietet nur die ersten 30 Gruppen an [#5514]
- OpenID Connect: Scopes können nicht konfiguriert werden [#5566]
- Migration 5.3.30_repair_consultation_events.php schlägt fehl [#5569]
- Datumsauswahl kaputt, wenn Nutzersprache auf Englisch eingestellt ist [#5570]
- Bilder im HTML Input (bsp. Forenbeiträge) haben fehlerhaften Alt-Text [#5576]
- API-Verwaltung: Registrierte Applikation kann nicht entfernt werden [#5583]
- JSONAPI-Authority für VA-Teilnehmer unterscheidet sich vom tatsächlichen Verhalten [#5587]
- Raumsuche: Individuelle Raumgruppen: Icons landen unter Auswahlbox [#5590]
- Inkonsistenz: Studiengruppen mit ausgeschalteter Verwaltungsseite [#5591]
- OpenID Connect: Domain wird immer angehängt [#5592]
- JSONAPI < 5.5: Keine Unterscheidung von CourseDate und CourseExdate möglich [#5599]
- Gruppenbelegungspläne anders sortiert als Individuelle Raumgruppen [#5601]
- ILIAS Authenticate ruft immer CheckAuthentication auf und triggert fehlerhafte Logins bei externen Authmethoden [#5622]
- Weitere Probleme mit Auth-Plugins [#5625]
- Diverse Probleme mit der MultiPersonSearch [#5629]
- Veranstaltungstitel verschwindet in Kachelansicht bei zu langen Wörtern [#5632]
- FileManager::getFileIcon: Generic-Icon bei Umlauten [#5636]
- Datenfelder mit Typ date lassen sich nicht wieder leeren [#5649]
- Datenfelder mit Typ time lassen sich nicht eingeben [#5650]
- Anzeige des Namens des Fachs anstatt des Studiengangteils [#5654]
- Seite mit Ausprägungen wird angezeigt, auch wenn nur eine zur Auswahl steht [#5656]
