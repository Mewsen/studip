 ...
 * @var bool $schedule True, if the view is rendered for the schedule, false otherwise.
...
<form class="default" method="post"
      action="<?= $controller->link_for($schedule ? 'calendar/schedule/add_courses' : 'calendar/calendar/add_courses') ?>">
