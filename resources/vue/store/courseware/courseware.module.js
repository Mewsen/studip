...
export const actions = {
    ...
    async copyStructuralElement({ dispatch, getters, rootGetters }, { parentId, elementId, migrate }) {
        const copy = { data: { parent_id: parentId, migrate: migrate } };
    ...
    async loadUsersCourses({ dispatch, rootGetters, state }, { userId, withCourseware }) {
        ...
        for (let membership of memberships) {
            if (membership.attributes.permission === 'dozent' || membership.attributes.permission === 'tutor') {
