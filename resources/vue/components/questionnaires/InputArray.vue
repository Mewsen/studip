                ...
                <template #item="{element, index}">
                    <tr>
                        <td class="dragcolumn">
                            <a class="dragarea"
                               tabindex="0"
                               :title="$gettextInterpolate($gettext(`Sortierelement für %{label} %{option}. Drücken Sie die Tasten Pfeil-nach-oben oder Pfeil-nach-unten, um dieses Element in der Liste zu verschieben.`), {option: element.value, label}, true)"
                        ...
                        <td class="actions">
                            <StudipIcon name="delete"
                                        ...
                                        :title="$gettextInterpolate($gettext('%{label} löschen'), {label: element.value}, true)"
                            />
                        </td>
                    </tr>
                </template>
