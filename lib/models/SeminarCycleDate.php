...
class SeminarCycleDate extends SimpleORMap
{
     ...
     * - long-start-no-room: Same as long-start but without the room.
    ...
    {
        if (!in_array($format, ['short', 'long', 'long-start', 'long-start-no-room', 'full'])) {
            //Invalid format:
            return '';
        }
        ...
        if ($format === 'short') {
            ...
            if ($format === 'long') {
            ...
            } elseif (in_array($format, ['long-start', 'long-start-no-room'])) {
                ...
                } elseif ($format !== 'long-start-no-room') {
