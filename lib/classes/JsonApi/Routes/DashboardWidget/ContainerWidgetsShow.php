...
/**
 * DashboardWidget's Container Widgets show route handler.
 *
 ...
 * @since   Stud.IP 6.3
 */
class ContainerWidgetsShow extends JsonApiController
{
    /**
     * @inheritdoc
    ...
    public function __invoke(Request $request, Response $response, $args)
    {
        ...
        if (!Authority::canShowContainerWidgets($user, $container)) {
